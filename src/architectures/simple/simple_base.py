...
class SimpleBase:
    def __init__(self, model_name, dataset_folder, columns,
        ...
        self.traingen = ImageDataGenerator(dataset=train_dataset, dataset_folder=self.dataset_folder,
                                           label_columns=columns)
        self.valgen = ImageDataGenerator(dataset=val_dataset, dataset_folder=self.dataset_folder,
                                         label_columns=columns)
        self.testgen = ImageDataGenerator(dataset=test_dataset, dataset_folder=self.dataset_folder,
                                          label_columns=columns)
